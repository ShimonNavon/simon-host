const WHATSAPP_NUMBER = "972549877094";
const WHATSAPP_DISPLAY = "054-987-7094";
const PREFILL = encodeURIComponent(
  "היי סיימון, הגעתי מהאתר של Simon Host ואשמח לשמוע על אתר לעסק שלי."
);
  ...
  return (
    <div className="bg-white border border-[#e8e2d6] rounded-2xl p-6 sm:p-10 text-center">
      <a
        ...
        className="btn-primary text-lg block w-full sm:inline-block sm:w-auto !px-5 sm:!px-8"
      >
